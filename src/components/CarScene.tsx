...
const MovingCar: React.FC<MovingCarProps> = ({ position = [1.5, -0.1, 25], ...props }) => {
  return (
    <RigidBody
      position={position}
      name="movingCar"
...
const Lamppost: React.FC<LamppostProps> = ({ position }) => {
  return (
...
const Building: React.FC<BuildingProps> = ({ position, height = 6, width = 2, depth = 3, color = "#b9c4d0" }) => {
...
const CarScene: React.FC<SceneProps> = (props) => {
  return <Scene {...props} />;
};
